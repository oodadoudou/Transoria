...
export const en: Messages = {
  ...
  epubOrganize: {
    ...
    sub: "Scan top-level EPUB files, match or create novel folders, then move files. Only file locations change; EPUB content and metadata stay untouched.",
    inputFolder: "Folder to organize",
    scan: "Scan preview",
    execute: "Organize",
    stop: "Stop",
    previewLabel: "Preview",
    noPlan: "Choose a folder and scan to preview which EPUB files will move.",
    noActions: "No EPUB files need organizing.",
    ...
    operation: "Action",
    score: "Score",
    moveExisting: "Move to existing folder",

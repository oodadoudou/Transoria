...
export const en: Messages = {
  ...
  epubMetadataTool: {
    title: "EPUB Metadata",
    sub: "Edit title, author, and cover as a new EPUB copy without rebuilding chapters, navigation, or body text.",
    ...
    currentLabel: "Current metadata",
    currentTitle: "Current title",
    currentAuthors: "Current authors",
    currentCover: "Current cover",
    coverPresent: "Cover present",
    coverMissing: "No cover",
    noMetadata: "Read an EPUB to show its current title, authors, and cover status.",
  ...
  generalTools: {
    ...
    epubMetadata: {
      title: "EPUB Metadata",
      sub: "Edit title, author, and cover without going through the merge flow.",
    },
  },
  appSettings: {
    crumb: "App Settings",

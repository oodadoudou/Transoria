...
export const en: Messages = {
  ...
  epubMetadataTool: {
    ...
    sub: "Choose an EPUB, edit title, author, and cover, then write a new EPUB to the selected output path without rebuilding chapters, navigation, or body text.",
    inputFile: "Input EPUB",
    inputPlaceholder: "Choose or paste an .epub file path",
    outputFile: "Output EPUB path",
    titleLabel: "Title",
    authorLabel: "Author",
    ...
    dialogSub: "OK writes the EPUB to the output path. If the output is blank, the input file path is used.",
    cancel: "Cancel",
    ok: "OK",

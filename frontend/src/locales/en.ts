...
export const en: Messages = {
  ...
  workflowPresets: {
    ...
    normalRoutes: "Translation routes",
    routeCount: "routes",
    addRoute: "Add route",
    removeRoute: "Remove",
    routeRpm: "RPM",
    routeRpmHint: "Maximum requests per minute for this route. 0 means unlimited.",
    groupConcurrency: "Total concurrency",
    failedRetry: "Retry failed chunks after the first pass",
    fallbackRoute: "Use a fallback model",
    routeMismatchWarning: "Routes use different models, thinking settings, or prompts. Translation style and quality may vary.",
    primaryRoute: "Default route",

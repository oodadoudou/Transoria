...
export const zh: Messages = {
  ...
  settingsToolbar: {
    save: "保存",
    reset: "恢复默认值",
    resetConfirm: "确定要将本模块设置恢复为默认值吗？当前设置会被丢弃。",
    saving: "保存中…",
    saved: "已保存",
    error: "保存失败",
    idle: "所有更改已保存",
  ...
  txtToEpubTool: {
    ...
    tocPresetText: {
      ...
      ko_novel: {
        label: "韩文小说",
        description: "韩文序章、回目、卷、番外、尾声和数字标题",
      },
      ja_novel: {
        label: "日文小说",
        description: "日文序章、回目、卷、番外、尾声和数字标题",
      },
      en_chapter: {
        label: "英文章节",
        description: "Chapter、Volume、Prologue、Epilogue 和数字标题",
      },
      numeric: {
        label: "数字标题",
    ...
    generating: "生成中",
    stop: "停止",
    outputHint: "输出文件名默认使用书名；输出目录为空时使用输入 TXT 同目录。",
    output: "输出",
    noOutput: "暂无输出文件",
    openOutputFolder: "打开输出目录",
    copyPath: "复制路径",

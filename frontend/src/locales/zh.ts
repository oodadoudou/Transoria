...
export const zh: Messages = {
  ...
  modelHints: {
    ...
    concurrency: "本配置同时发起的请求数。值越高越快，但可能触发单密钥限速。",
  ...
  batchReplacement: {
    title: "批量替换",
    sub: "使用导入的箭头规则（`原文->新文`）替换 TXT 和 EPUB 文件。",
    inputFolder: "源文件夹",
    outputFolder: "输出文件夹",
    rulesLabel: "规则",
    importRules: "导入 TXT 规则",
    noRules: "尚未导入规则。请导入包含 `原文->新文` 条目的 TXT 文件。",
    execute: "执行",
    stop: "停止",
    progressLabel: "进度",
    statusLabel: "状态",
  ...
  epubOrganize: {
    title: "EPUB 整理",
    sub: "扫描当前目录的一层 EPUB，按小说名匹配或创建文件夹后移动文件；只改文件位置，不修改 EPUB 内容或 metadata。",
    inputFolder: "待整理文件夹",
    scan: "扫描预览",
    execute: "执行整理",
    stop: "停止",
    previewLabel: "预览",
    noPlan: "选择文件夹并扫描后，会在这里显示将要移动的 EPUB。",
    noActions: "没有需要整理的 EPUB。",
    epubsFound: "EPUB 文件",

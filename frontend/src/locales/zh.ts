...
export const zh: Messages = {
  ...
  requestLog: {
    ...
    empty: "暂无请求记录。",
    errorPrefix: "请求记录加载失败：",
    showing: "显示 {shown} / {total} 条请求",
    showingRecent: "显示最近 {shown} 条请求",
    truncated: "可加载更早的保留记录",
    filterLabel: "请求状态筛选",
    filterAll: "全部",
    filterRunning: "请求中",
    filterCompleted: "已完成",
    ...
    statusCancelled: "已取消",
    phaseSent: "已发送",
    phaseHeadersReceived: "已收到响应头",
    phaseFirstToken: "已收到首段回复",
    phaseStreaming: "回复中",
    phaseValidation: "本地校验",
    phaseCompleted: "已完成",
    phaseFailed: "失败",
    phaseCancelled: "已取消",
    attempt: "第 {n} 次",
    lastActivity: "最后活动 {time}",
    responseChars: "回复 {n} 字",
    secondsSuffix: " 秒",
    inputTokens: "输入 {n}",
    outputTokens: "输出 {n}",
    cachedTokens: "缓存 {n}",
    ...
    currentCache: "当前缓存",
    cacheMatched: "已采纳",
    cacheDifferent: "已有其他译文",
    cacheMissing: "未写入",
    rawResponse: "查看原始回复",
    copySegmentId: "复制校对序号",
    copyDone: "已复制",
    copyFailed: "复制失败",
  },
  allKeysFailed: {
  ...
  firstRun: {
    ...
    subtitle:
      "选择 provider、粘贴 API key 后，Transoria 会把这个配置同时用于翻译、术语提取和术语审查。",
    providerLabel: "Provider",
    loadingProviders: "加载中…",
    noProviders: "没有可用的 provider 模板。",
    customProviderMeta: "自定义端点",
    apiKeyLabel: "API key",
    apiKeyPlaceholder: "粘贴 API key",
    customDefaultName: "自定义 Provider",
    customNameLabel: "配置名称",
    customBaseUrlLabel: "Base URL",
    customModelIdLabel: "模型 ID",
    skipAction: "跳过",
    finishAction: "完成配置",
    savingAction: "保存中…",
    savedTitle: "Provider 已就绪",
  },
  rowMenu: {
    triggerLabel: "更多操作",
    view: "查看",
  ...
  quickSwitch: {
    ...
    emptyPreset: "无预设。请先到预设管理页创建一套配置组合。",
    manageLink: "管理…",
  },
  runConfig: {
    preset: "预设",
    ...
    switchAction: "切换",
    noPreset: "无预设",
    noPresetHint: "打开预设管理页创建",
    customPreset: "自定义配置",
    missingModel: "未选择模型",
    missingPrompt: "未选择 Prompt",
  },
  promptModal: {
  ...
  epubMergeTool: {
    title: "文本文档合并",
    sub: "选择 EPUB 或 TXT。EPUB 会按顺序合并并重建目录和资源引用；TXT 会按顺序拼接为一个 UTF-8 文本文档。源文件不会被修改。",
    ...
    stop: "停止",
    previewLabel: "预览",
    noPlan: "选择文件夹并扫描后，会在这里显示可合并文件和默认输出文件。",
    noActions: "没有可合并文件。",
    epubsFound: "EPUB 文件",
    txtFound: "TXT 文件",
    selectedCount: "已选择",
  ...
  epubConvertTool: {
    ...
    chooseFile: "选择 EPUB",
    recursive: "递归扫描子文件夹",
    outputFolder: "输出目录（可留空）",
    outputHint: "留空时 TXT 会写到输入 EPUB 所在目录，同名文件会自动追加序号。",
    scan: "扫描预览",
    execute: "执行转换",
    stop: "停止",
    previewLabel: "预览",
  ...
  epubRepairTool: {
    title: "EPUB 修复",
    sub: "尽量把异常 XHTML/XML、裸实体和不规范标签整理成标准 EPUB 内容，输出新 EPUB；不会修改翻译 parser、元数据或目录策略。",
    inputFile: "输入 EPUB",
    inputPlaceholder: "选择或粘贴需要修复的 .epub 文件路径",
    outputFolder: "输出文件夹",
    chooseEpub: "选择 EPUB",
    chooseOutputFolder: "选择文件夹",
    generatedOutput: "将输出为",
    ...
    voidContainers: "异常标签",
    wrappersAdded: "补全文档壳",
    noResult: "选择 EPUB 后执行修复，会在这里显示修复统计。",
    repaired: "已写入修复后的 EPUB。",
    preview: "预览修改",
    previewLabel: "修复预览",
    toRepair: "将修改文档",
    structure: "结构检查",
  ...
  txtToEpubTool: {
    inputTxt: "输入 TXT",
    inputPlaceholder: "选择或粘贴 .txt 文件路径",
    chooseTxt: "选择 TXT",
    outputDir: "输出目录",
    titleLabel: "书名",
    titlePlaceholder: "留空则使用 TXT 文件名",
    syncFilenameWithTitle: "输出文件名跟随书名 metadata",
    outputFilename: "输出文件名",
    authorLabel: "作者",
    optionalPlaceholder: "可选",
    cover: "封面",
    coverPlaceholder: "可选：jpg / png / webp",
    chooseCover: "选择封面",
    chapterRecognition: "章节识别",
    modePreset: "预设",
    modeSimple: "简单正则",
    modeAdvanced: "高级正则",
    levelRule: "{level} 级标题正则",
    levelRulePlaceholder: "例如 ^#{level}\\s*(?P<title>.+)$",
    advancedRegex: "高级正则",
    advancedRegexPlaceholder: "例如 ^第\\d+章\\s*(?P<title>.*)$",
    scanToc: "扫描目录",
    scanSummary: "{candidates} 个候选 · {selected} 个启用 · {lines} 行",
    scanHint: "扫描后可编辑标题、层级和是否进入目录。",
    selectedRows: "已选 {count} 项",
    selectAll: "选择",
    addTocText: "按文本新增目录",
    ...
    epubStyle: "EPUB 样式",
    customCss: "自定义样式",
    customCssHint: "基于模板修改",
    copyTemplate: "复制模板",
    downloadTemplate: "下载模板",
    importCss: "导入 CSS",
    resetTemplate: "重置模板",
    stylePreviewTitle: "EPUB 样式预览",
    generate: "生成 EPUB",
    generating: "生成中",
    stop: "停止",
    outputHint: "输出文件名默认跟随书名；取消勾选后可单独设置输出 EPUB 文件名。",
    output: "输出",
    noOutput: "暂无输出文件",
    openOutputFolder: "打开输出目录",
    copyPath: "复制路径",
    copiedPath: "已复制输出路径",
    reportSummary: "写入章节 {chapters} · 目录项 {toc} · 字符 {characters}",
    overwriteConfirm: "输出文件已存在：\n{path}\n\n是否覆盖？",
    cssImportBlocked: "自定义 CSS 不能使用 @import。",
    cssUrlBlocked: "自定义 CSS 不能引用远程 URL 或本地绝对路径。",
    previewHeading1: "第一卷 春日",
    ...
    proofreadingPage: {
      ...
      regenerateFailureReasons: {
        ...
        cacheSegmentMismatch:
          "源文件和任务缓存对不上：当前解析到 {expected} 段，其中 {matched} 段能匹配缓存，仍缺 {missing} 段。首个缺失段落：{firstMissing}。当前源指纹：{parsedFingerprint}；缓存源指纹：{cacheFingerprint}。通常是原输入文件内容/同目录文件列表变化，或新版本解析器识别出了旧任务没有翻译过的段落。为避免把原文混入译文，已停止生成。",
        missingTranslations:
      ...
      statusGlossaryNotApplied: "术语未应用",
      statusGlossaryNotAppliedHint:
        "原文段落命中了术语表条目，但译文中没有出现该条目的规范译名。",
      statusTermInconsistency: "术语不一致",
      statusTermInconsistencyHint:
        "同一术语形态在部分命中段落中应用了规范译名，另一些命中段落没有应用。",
      ...
      stats: {
        ...
        glossaryNotApplied: "{n} 术语未应用",
        termInconsistency: "{n} 术语不一致",
        possibleDuplicate: "{n} 疑似重复",
        modelAnomaly: "{n} 模型异常",
        untranslated: "{n} 未译",
      },
      qualitySummaryClean: "当前列表没有检测到需要优先校对的风险。",
      qualitySummaryNeedsReview: "当前任务有 {n} 条需要优先校对：{focus}。",
      qualitySummaryFocus: "{label} {n}",
      filterPresetDefault: "默认风险",
      filterPresetHighRisk: "高风险",
      filterPresetCompletion: "完成度",
      filterPresetAll: "全部风险",
      selectionSummary: "已选 {selected} · 显示 {visible}/{total}",
      filterClear: "清空筛选",
      filterClearDisabled: "当前没有筛选条件可清空。",
      riskReasonPrefix: "原因：",
      riskTagsPrefix: "标签：",
      filterPlaceholder: "搜索序号 / 原文 / 译文…",
      filterOnlyLowConfidence: "低置信",
      filterOnlySourceResidue: "原文残留",
      filterOnlyGlossaryNotApplied: "术语未应用",
      filterOnlyTermInconsistency: "术语不一致",
      ...
      termAuditGroupCount: "{n} 个术语组",
      termAuditApplied: "已应用 {n}",
      termAuditMissing: "缺失 {n}",
      ...
      retranslatePreset: "预设",
      retranslateModel: "模型",
      retranslatePrompt: "Prompt",
      retranslatePresetPickerTitle: "选择校对重翻预设",
      ...
      taskFolderLabel: "输出位置：",
      copyOutputPath: "复制",
      copyOutputPathDone: "已复制输出路径。",
  ...
  generalTools: {
    ...
    epubTools: {
      title: "EPUB 工具",
      sub: "把 EPUB 压缩、合并、转换、元数据、修复和 TXT 转 EPUB 集中在一个页面中。",
      intro: "选择一个工具后会打开独立弹窗，保留原有功能和任务缓存。",
      open: "打开",
      close: "关闭",
    },
    epubCompress: {
    ...
    epubMerge: {
      title: "文本文档合并",
      sub: "按用户选择的顺序合并 EPUB 或 TXT；EPUB 会重建目录与资源引用，TXT 会直接拼接输出。",
    },
    epubConvert: {
      title: "EPUB 转 TXT",
    ...
    epubRepair: {
      title: "EPUB 修复",
      sub: "规范化 EPUB 内部异常 XHTML/XML，输出一个可供后续转换或翻译使用的新 EPUB。",
    },
  },
  appSettings: {
    crumb: "应用设置",
  ...
  workflowPresets: {
    pageTitle: "预设",
    pageSub: "把模型、Prompt 和语言设置保存成一套组合。运行页可以一键切换整套配置。",
    currentConfig: "当前组合",
    currentHint: "当前运行配置会在这里汇总显示。",
    available: "可用预设",
    availableHint: "双击可编辑；使用会同步切换模型、Prompt 和语言设置。",
    emptyTitle: "无预设",
    emptyBody: "先创建一个预设，之后可以更快切换常用配置组合。",
    addAction: "新建预设",
    createFromCurrent: "从当前配置新建",
    formTitleCreate: "新建预设",
    formTitleEdit: "编辑预设",
    defaultName: "新预设",
    nameLabel: "预设名",
    namePlaceholder: "例如：常用翻译配置",
    modelLabel: "模型",
    promptLabel: "Prompt",
    ...
    activeBadge: "当前",
    badgeCustom: "自定义",
    customConfig: "当前配置未匹配任何预设",
    missingSelection: "请先选择模型和 Prompt。",
    advanced: "高级配置",
    normalRoutes: "翻译线路",
    routeCount: "条线路",
    addRoute: "添加线路",
    removeRoute: "移除",
    routeRpm: "RPM",
    routeRpmHint: "此线路每分钟最多发送的请求数。0 表示不限。",
    groupConcurrency: "总并发",
    failedRetry: "首轮结束后重试失败分块",
    fallbackRoute: "使用兜底模型",
    routeMismatchWarning: "线路使用不同的模型、思考设置或 Prompt，译文风格和质量可能不一致。",
    primaryRoute: "默认线路",
    setPrimary: "设为默认",
  },
  model: {

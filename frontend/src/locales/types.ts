...
export interface Messages {
  ...
  translation: {
    ...
    proofreadingPage: {
      ...
      statusGlossaryNotApplied: string;
      statusGlossaryNotAppliedHint: string;
      statusTermInconsistency: string;
      ...
      stats: {
        ...
        glossaryNotApplied: string;
        termInconsistency: string;
      ...
      filterOnlyGlossaryNotApplied: string;
      filterOnlyTermInconsistency: string;
      ...
      termAuditSub: string;
      termAuditGroupCount: string;
      termAuditApplied: string;
      termAuditMissing: string;
      ...
      retranslateUnresolved: string;
      retranslateCandidateLabel: string;
      retranslateCandidateReason: string;
      retranslateCandidateEdit: string;
      retranslateCandidateKeep: string;
  ...
  txtToEpubTool: {
    ...
    coverPlaceholder: string;
    chooseCover: string;
    chapterRecognition: string;
    modePreset: string;
    modeSimple: string;
    modeAdvanced: string;
    levelRule: string;
    levelRulePlaceholder: string;
    advancedRegex: string;
    advancedRegexPlaceholder: string;
    scanToc: string;
    scanSummary: string;
    scanHint: string;
    selectedRows: string;
    ...
    cssImportBlocked: string;
    cssUrlBlocked: string;
